    ...
    return (
        ...
        >
            <div className="mb-12 flex h-48 items-end justify-center">
                <span
                    className="animate-pop text-[8rem] leading-none"
                    key={plant}
                >
                    {plant}
                </span>
