        ...
        >
            <div className="flex w-full max-w-md flex-col items-center gap-10">
                ...
                <div className="flex h-56 w-full items-center justify-center rounded-4xl bg-[#E8EDF2] text-[7rem] shadow-[inset_-4px_-4px_8px_rgba(255,255,255,0.9),inset_4px_4px_8px_rgba(0,0,0,0.06)]">
                    <span key={step} className="animate-pop">
                        {scene.visual}
                    </span>
                </div>
                ...
                <button
                    ...
                    className="flex size-32 items-center justify-center rounded-full bg-[#D2232A] text-7xl shadow-[-6px_-6px_12px_rgba(255,255,255,0.9),6px_6px_12px_rgba(0,0,0,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[-8px_-8px_16px_rgba(255,255,255,0.9),8px_8px_16px_rgba(0,0,0,0.1)] active:translate-y-0.5 active:scale-[0.93] active:shadow-[inset_-4px_-4px_8px_rgba(255,255,255,0.3),inset_4px_4px_8px_rgba(0,0,0,0.15)]"
