                ...
                <div className="flex min-h-[120px] flex-wrap items-center justify-center gap-4">
                    {remaining.map((it) => (
                        <button
                            ...
                            className={`flex size-24 items-center justify-center rounded-4xl bg-[#E8EDF2] text-6xl shadow-[-6px_-6px_12px_rgba(255,255,255,0.9),6px_6px_12px_rgba(0,0,0,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[-8px_-8px_16px_rgba(255,255,255,0.9),8px_8px_16px_rgba(0,0,0,0.1)] active:translate-y-0.5 active:scale-[0.97] active:shadow-[inset_-4px_-4px_8px_rgba(255,255,255,0.9),inset_4px_4px_8px_rgba(0,0,0,0.1)] ${
                                selected?.key === it.key
                ...
                <div className="flex justify-center gap-5">
                    {(['fruit', 'veg'] as const).map((cat) => (
                        <button
                            key={cat}
                            onClick={() => drop(cat)}
                            className={`flex min-h-[160px] flex-1 flex-col items-center justify-center gap-2 rounded-4xl bg-[#E8EDF2] p-4 shadow-[-6px_-6px_12px_rgba(255,255,255,0.9),6px_6px_12px_rgba(0,0,0,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[-8px_-8px_16px_rgba(255,255,255,0.9),8px_8px_16px_rgba(0,0,0,0.1)] active:translate-y-0.5 active:scale-[0.97] active:shadow-[inset_-4px_-4px_8px_rgba(255,255,255,0.9),inset_4px_4px_8px_rgba(0,0,0,0.1)] ${
                                shake === cat ? 'animate-wiggle' : ''
