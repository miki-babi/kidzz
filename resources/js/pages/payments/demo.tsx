...
export default function DemoPayment({ game, price }: Props) {
    ...
    const submit = (event: FormEvent<HTMLFormElement>): void => {
        ...
        router.post('/pay', form, {
            preserveScroll: true,
            onStart: () => {
                console.log('[DemoPayment] inertia post started', {
                    route: '/pay',
                });
            },
            onSuccess: () => {
                console.log(
                    '[DemoPayment] inertia post success, redirect expected',
                    { route: '/pay' },
                );
            },
            onError: (errors) => {
                console.log(
                    '[DemoPayment] inertia post validation error',
                    errors,
                );
            },
            onFinish: () => {
                ...
                <main className="mx-auto max-w-4xl px-6 py-12 lg:px-8">
                    <div className="rounded-[2rem] bg-white p-6 shadow-xl ring-1 ring-neutral-100 dark:bg-zinc-950 dark:ring-zinc-800">
                        <div className="space-y-4 rounded-[1.5rem] bg-gradient-to-br from-red-600 via-red-600 to-orange-500 p-6 text-white">
                            <div className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-2 text-xs font-bold tracking-[0.2em] uppercase">
                                <Sparkles className="h-4 w-4" />
                                Checkout
                            </div>
                            <h1 className="text-3xl font-black tracking-tight">
                                Pay {price.toFixed(2)} USD to unlock all premium
                                games
                            </h1>
                            <p className="max-w-2xl text-sm leading-relaxed text-white/85">
                                This is a demo payment page for demo purposes.
                                Filling out the form and submitting it will mark
                                the account as paid and unlock every game.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="mt-8 grid gap-4">
                            <div className="grid gap-4 sm:grid-cols-2">
                                <label className="grid gap-2">
                                    <span className="text-sm font-bold text-neutral-700 dark:text-zinc-300">
                                        Cardholder name
                                    </span>
                                    <input
                                        required
                                        ...
                                        className="rounded-2xl border border-neutral-200 bg-white px-4 py-3 text-sm transition outline-none focus:border-red-500 dark:border-zinc-800 dark:bg-zinc-900"
                                    />
                                </label>
                                <label className="grid gap-2">
                                    <span className="text-sm font-bold text-neutral-700 dark:text-zinc-300">
                            ...
                            <div className="grid gap-3 rounded-3xl bg-neutral-50 p-4 sm:grid-cols-2 dark:bg-zinc-900">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-neutral-500">
                                            Submission marks the whole account
                                            as premium.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <button
                                ...
                                onClick={() => {
                                    console.log(
                                        '[DemoPayment] pay button clicked',
                                        {
                                            game,
                                            form,
                                        },
